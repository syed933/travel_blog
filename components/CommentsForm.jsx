    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 mb-8'>
            ...
            <div className='mt-8'>
                ...
                className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-blue-500
                text-lg rounded-full text-white px-8 py-3 cursor-pointer hover:scale-110
                '
                >
                    Post Comment
                </button>
                ...
                >
                Comment submited for review</span>}
            </div>
        </div>
    )
}
