    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 w-full'>
            <div className="relative overflow-hidden shadow-md pb-80 mb-6">
                ...
                alt={post.title}
                className='object-top absolute h-80 w-full object-scale-down shadow-lg p-5 rounded-t-lg lg:rounded-lg'
                />
            </div>
            ...
            lg:px-20 mb-8'>{post.excerpt}</p>
            <div className="text-center">
                <Link href={`/post/${post.slug}`}>
                    <span className='transition duration-500 transform hover:-translate-y-1
                    inline-block bg-blue-500 text-lg font-medium rounded-lg text-white px-10 py-3 cursor-pointer'
                    >
                        Continue Reading
                    </span>
                </Link>
